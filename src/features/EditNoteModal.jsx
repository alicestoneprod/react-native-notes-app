...
export const EditNoteModal = ({
  ...
  const deleteNote = (id) => {
    Alert.alert(
      "Предупреждение",
      "Вы действительно хотите удалить заметку? Это действие невозможно отменить",
      [
        {
          text: "Нет",
        },
    ...
    <View style={styles.container}>
      ...
      <View style={styles.additionalButtonsCnt}>
        <TouchableHighlight
          ...
          <Image source={require("./add.png")}></Image>
        </TouchableHighlight>
        <TouchableHighlight
          onPress={() => {
            deleteNote(currentNote?.datetime)
          }}>
      ...
      <View style={styles.buttonsCnt}>
        ...
        <TouchableHighlight
          onPress={() => {
            handleSave(currentNote?.datetime)
          }}
          style={[styles.btnCnt]}>
